...
public class TC03VirtualDownloadableSecilebilmeli {
    @Test public void Test3() throws InterruptedException {
        ...
        //Kullanici Virtual Downloadable i secebildigini gorur
        productsPages.virtualDownloadable.click();
        Assert.assertTrue(productsPages.virtualDownloadable.isDisplayed());
    }
}
