...
public class TC02_Inventory {
    ...
    public void testName() throws InterruptedException {
        ...
        vendorProduct.inventorySku.sendKeys("100"+Keys.ENTER);//Inventory bolumune 100 yazar
        vendorProduct.manageStock.click();//ManageStock bolumu tiklanir
        vendorProduct.stockQty.sendKeys(ConfigReader.getProperty("randomnumber"));

        Select select=new Select(vendorProduct.allowBackorders);
        select.selectByIndex(2);
        Thread.sleep(2);
        vendorProduct.soldindividually.click();
        vendorProduct.manageStock.click();

        Select select1=new Select(vendorProduct.stockstuckddm);
