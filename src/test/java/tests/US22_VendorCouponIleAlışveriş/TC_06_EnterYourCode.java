package tests.US22_VendorCouponIleAlışveriş;
...
public class TC_06_EnterYourCode {
    ...
    public void test01() {
        ...
        ReusableMethods.waitWithThreadSleep(2);
        js.executeScript("arguments[0].click();", vendorGirisPage.vendorentercodplace);
        ReusableMethods.waitWithThreadSleep(2);
        js.executeScript("arguments[0].setAttribute;", "123456asa",vendorGirisPage.vendorentercodplace);
        ReusableMethods.waitWithThreadSleep(2);
        js.executeScript("arguments[0].click();", vendorGirisPage.vendorapplycoupon);
